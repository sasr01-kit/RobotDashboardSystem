'''DrawingData represents the drawing created by the child during a session, stored as a base64-encoded PNG image.'''
class DrawingData:
    def __init__(self, base64_data: str): 
        # Store the base64-encoded PNG image data (without prefix)
        self.base64 = base64_data      
    
    '''Convert the DrawingData object to a dictionary for JSON serialization.'''
    def to_dict(self):
